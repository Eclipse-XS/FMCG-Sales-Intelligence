...
The authoritative machine registry is `contracts/registry_v1.yaml`. It defines 11 contracts: `sales_daily`, `sku_master`, `locations`, `prices`, `inventory_snapshots`, `deliveries`, `orders`, `order_items`, `promotions`, `promotion_stores`, and `promotion_skus`.

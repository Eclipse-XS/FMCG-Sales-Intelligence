...
from fmcg_sales_intelligence.science.segmentation import DEFAULT_CONFIG, audit_features, canonicalize, evaluate_candidates, nearest_centroid, select_latest_snapshot

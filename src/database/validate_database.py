...
def main():
    ...
    with connect() as conn:
        with conn.cursor() as cur:
            ...
            sql_text=(ROOT/"db/queries/smoke.sql").read_text(encoding="utf-8")
    ...
    report["passed"]=passed;(ROOT/"reports/database_validation.json").write_text(json.dumps(report,indent=2),encoding="utf-8")
    ...
    (ROOT/"reports/database_validation.md").write_text("\n".join(lines)+"\n",encoding="utf-8")

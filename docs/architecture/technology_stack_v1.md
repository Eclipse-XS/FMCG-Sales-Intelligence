...
| DVC | data/pipeline/canonical-artifact ownership | ACTIVE_EXECUTED; no remote |
...
| React, TypeScript, Vite, ECharts | business dashboard | ACTIVE_EXECUTED locally |
...
| Kafka | ingestion/replay simulation | IMPLEMENTED_NOT_RUNTIME_VERIFIED |
| Airflow | DAG definition | IMPLEMENTED_NOT_RUNTIME_VERIFIED |

...
def main():
    ...
    defaults = {
        "forecasting": ("config/modeling/forecasting.yaml", "data/processed/forecasting/forecasting_v1.parquet"),
        "stockout_classification": ("config/modeling/stockout_classification.yaml", "data/processed/stockout/stockout_v1.parquet"),
        "stockout_survival": ("config/modeling/stockout_survival.yaml", "data/processed/stockout/stockout_v1.parquet"),
        "segmentation": ("config/modeling/segmentation.yaml", "data/processed/segmentation/segmentation_v1.parquet"),
        "anomaly": ("config/modeling/anomaly.yaml", "data/processed/anomaly/anomaly_v1.parquet"),
        "basket": ("config/modeling/basket.yaml", "data/processed/basket/basket_v1.parquet"),
        "promotion": ("config/modeling/promotion.yaml", "data/processed/promotion_daily/promotion_daily_v1.parquet"),
    }
